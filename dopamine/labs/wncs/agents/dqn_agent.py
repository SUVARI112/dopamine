...
from dopamine.labs.wncs import env
...
"""
The JaxDQNAgent file is more like a coordinator - it handles the reinforcement learning logic
(like replay buffer management, epsilon-greedy exploration,training loops) but doesn't define how 
states are processed. That happens in the network definition, which is imported from dopamine.jax.networks
"""

# NATURE_DQN_OBSERVATION_SHAPE = env.NATURE_DQN_OBSERVATION_SHAPE
# NATURE_DQN_DTYPE = jnp.uint16
